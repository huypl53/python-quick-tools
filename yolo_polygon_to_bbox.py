"""
Convert YOLO polygon labels to YOLO bounding boxes.

Usage examples:
  python yolo_polygon_to_bbox.py /path/to/labels_root /path/to/output_labels
  python yolo_polygon_to_bbox.py /path/to/labels_root --in-place
"""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Convert YOLO polygon labels to YOLO bounding boxes."
    )
    parser.add_argument(
        "source",
        type=Path,
